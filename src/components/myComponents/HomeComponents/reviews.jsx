...
// const GoogleReviews = ({placeId="ChIJEc0X4SW5yhQRFBKcecfY1F4", apiKey="AIzaSyBnE895PwMd-ufYsM4-8d92OtqtmrLE8GI"}) => {
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="section-title text-center mb-60">
              ...
              <h2 className=" ar">آراء العملاء</h2>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="tesimonial-card-wrapper">
      <div className="tesimonial-card">
        ...
        <div className="testimonial-bottom">
          ...
          <div className="date-and-time ar">
            <p>{review?.date}</p>
            {/* <span>10.30 PM</span> */}
          </div>
        </div>
      ...
      <div className="author-area">
        <div className="author-img">
          <img
            ...
            // "/assets/img/home1/testi-author-img1.png"
            alt=""
          />
        </div>
