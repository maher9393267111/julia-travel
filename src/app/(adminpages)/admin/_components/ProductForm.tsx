...
//         <div className="flex  col-span-3 flex-wrap  gap-5">
//           {images.map((image: any, index: number) => (
//             <div
//               key={index}
//               className="p-5 w-[200px] border-solid border border-gray-300 rounded-md overflow-hidden flex flex-col items-center justify-center gap-2"
//             >
//               <Image
...
//           <Button className=" w-[200px]  rounded-md" htmlType="submit" type="primary">
//             Save
//           </Button>
//         </div>
//       </div>
