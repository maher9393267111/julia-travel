...
const Page = () => {
  ...
  const getFlight = async () => {
    try {
      ...
      const response = await axios.get(
        `/api/admin/flights/${params?.flight_id}`
      );
  ...
  return (
    <>
      <Breadcrumb pagename="تفاصيل الرحلة" pagetitle="تفاصيل التنقل" />
              ...
              <div className="col-lg-8">
                <div className="transport-image-area mb-50">
                  ...
                  <ul className="nav nav-tabs" id="myTab5" role="tablist">
                    {flight?.images?.length > 0 && flight?.images[0] && (
                    ...
                    {flight?.images?.length > 0 && flight?.images[1] && (
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="interior-tab"
                    ...
                    {flight?.images?.length > 0 && flight?.images[2] && (
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="video-clip-tab"
                    ...
                    {flight?.images?.length > 0 && flight?.images[3] && (
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="color-clip-tab"
                    ...
                    {flight?.images?.length > 0 && flight?.images[4] && (
                      <li className="nav-item" role="presentation">
                        <button
                          className="nav-link"
                          id="color-clip2-tab"
                ...
                {flight?.description && (
                  <p className=" ar">{parse(flight?.description)}</p>
                )}
              ...
              <div className="col-lg-4">
                <div className="transport-sidebar">
                  <div className="booking-form-wrap">
                    <h4 className=" ar">احجز رحلتك الان</h4>
                    <p className=" !text-2xl font-semibold !text-[#63AB45]">
                      {flight?.price}$
