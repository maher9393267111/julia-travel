...
<h5 className=" ar">ابحث هنا</h5>


                      <h5 onClick={ResetSearch} className=" cursor-pointer ar "> اعادة تعيين</h5>
</div>
            ...
            <ul>
              <li>
                <Checkbox
                  ...
                  checked={
                    checkboxes.vites && checkboxes.vitesalue === "automatic"
                  }
                >
                  اوتوماتك
                </Checkbox>
              ...
              <li>
                <Checkbox
                  ...
                  checked={
                    checkboxes.vites && checkboxes.vitesalue === "manual"
                  }
                >
                  عادي
                </Checkbox>
            ...
            <ul>
              <li>
                <Checkbox
                  ...
                  checked={
                    checkboxes.fueltype && checkboxes.fuelvalue === "gaz"
                  }
                >
                  غاز
                </Checkbox>
              ...
              <li>
                <Checkbox
                  ...
                  checked={
                    checkboxes.fueltype && checkboxes.fuelvalue === "dizil"
                  }
                >
                  ديزل
                </Checkbox>
