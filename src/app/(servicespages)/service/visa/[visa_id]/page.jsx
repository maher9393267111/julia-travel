                  ...
                  <div className="document-list ar">
                    ...
                    <ul className=" ar">
                      <li>
                        ...
                        نسخة ممسوحة ضوئيًا من جواز السفر: يلزم وجود نسخة ممسوحة
                        ضوئيًا من جواز السفر. يشترط صلاحية لا تقل عن 6 أشهر من
                        تاريخ الوصول.
                      </li>
                      <li>
                        <svg
                        ...
                        مواصفات الصورة: صورة بحجم جواز السفر مع خلفية بيضاء
                        (مطلوب نسخة ممسوحة ضوئيًا واضحة)
                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        نسخة التأشيرة السابقة: إذا كان لدى المسافر تاريخ سفر
                        سابق إلى دول مثل تايلاند وماليزيا وسنغافورة والولايات
                        المتحدة الأمريكية والمملكة المتحدة وما إلى ذلك، فيحتاج
                        إلى نسخة واضحة ممسوحة ضوئيًا من التأشيرة.
                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                        ...
                        حجز الطيران والفنادق مع التواريخ المحددة بوضوح (لا تقم
                        بالشراء حتى الموافقة على التأشيرة)
                      </li>
                      <li>
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
